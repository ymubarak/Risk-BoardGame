...
class AStarRealTime(Player, Agent):
    ...
    def attacked_search(self):
        ...
        while targets:
            ...
            if min_node.g_value == 3:
                return self.find_attacked(min_node)
    ...
    def find_succesors(self, t, attackers, targets_temp):
    	succesors = []
    	for nbr in t.neighbors():
    		if nbr not in attackers and nbr not in targets_temp:
